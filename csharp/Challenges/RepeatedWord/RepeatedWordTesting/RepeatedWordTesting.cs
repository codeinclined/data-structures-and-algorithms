...
{
    public class RepeatedWordTesting
    {
        [Theory]
        ...
        [InlineData("There should be no repeats in this one", null)]
        public void RepeatedWordTest(string inputString, string expectedFirstRepeatedWord)
        {
            // Assert
            Assert.Equal(expectedFirstRepeatedWord, Program.RepeatedWord(inputString));
        }
    }
}
